...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2019 at 05:11 PM
...
INSERT INTO `post` (`id`, `user_id`, `title`, `body`, `published`, `created_at`, `updated_at`, `category_id`, `image_id`) VALUES
(1, 1, 'Less plastic', 'this is the body of \"less plastic\" article', '0000-00-00 00:00:00', '2019-04-17 11:00:26', NULL, 2, 1),
(2, 1, 'how to travel with kids', 'this is the body of \"how to travel with kids\"', NULL, '2019-04-17 11:03:15', NULL, 3, 2);
...
ALTER TABLE `post`
  ...
  ADD CONSTRAINT `post_ibfk_3` FOREIGN KEY (`image_id`) REFERENCES `image` (`id`);
